...
export default function Menu({ menuIsOpen, setMenuIsOpen, setEstado }){
    ...
    const ReferenciaBtn4 = useRef(null)

    useEffect(() => {
        gsap.to(ReferenciaBtn1.current, {opacity: 1, x: 0, duration: .4})
        gsap.to(ReferenciaBtn2.current, {opacity: 1, x: 0, duration: .4, delay: .2})
        gsap.to(ReferenciaBtn3.current, {opacity: 1, x: 0, duration: .4, delay: .3})
        gsap.to(ReferenciaBtn4.current, {opacity: 1, x: 0, duration: .4, delay: .1})
    })
    ...
    return (<>
        ...
        <MenuStyled>
            ...
            <div className="btnHolder">
                ...
                <MenuButton onClick={() => {setEstado(5); setMenuIsOpen(false)}} ref={ReferenciaBtn4}>PROJETOS</MenuButton>
